...
/****** Object:  Database [db_Libary]    Script Date: 29-06-2020 8:27:38 AM ******/
...
USE [db_Libary]
GO
/****** Object:  Table [dbo].[tbBooks]    Script Date: 29-06-2020 8:27:38 AM ******/
SET ANSI_NULLS ON
GO
...
GO
/****** Object:  Table [dbo].[tbBooks_Detail]    Script Date: 29-06-2020 8:27:39 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[tbCategory]    Script Date: 29-06-2020 8:27:39 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[tbMember]    Script Date: 29-06-2020 8:27:39 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[tbRent_Book]    Script Date: 29-06-2020 8:27:39 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[tbRent_Detail]    Script Date: 29-06-2020 8:27:39 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[tbType]    Script Date: 29-06-2020 8:27:39 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  View [dbo].[vw_ShowLostBooks]    Script Date: 29-06-2020 8:27:39 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
AS
SELECT dbo.tbBooks.barcode, dbo.tbBooks_Detail.bname, dbo.tbBooks_Detail.page, dbo.tbCategory.name, dbo.tbType.typename, dbo.tbRent_Book.qty, dbo.tbBooks_Detail.tbdid, dbo.tbRent_Detail.status, dbo.tbRent_Detail.datest, dbo.tbRent_Detail.dateed, dbo.tbRent_Detail.mbid, 
             dbo.tbMember.fname, dbo.tbMember.lname, dbo.tbMember.tel
...
GO
/****** Object:  Table [dbo].[tbBook_Lost]    Script Date: 29-06-2020 8:27:39 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE TABLE [dbo].[tbBook_Lost](
	...
	[catgname] [nvarchar](100) NOT NULL,
	[typename] [nvarchar](100) NOT NULL,
	[tbdid] [nvarchar](10) NULL,
	[date] [date] NOT NULL,
...
GO
/****** Object:  View [dbo].[vw_Book_Lost_ByMunth]    Script Date: 29-06-2020 8:27:39 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
Create View [dbo].[vw_Book_Lost_ByMunth]
as

Select barcode, bname, page, qty, cost, catgname, typename, tbdid, Month(date) [month_now] From tbBook_Lost
GO
/****** Object:  View [dbo].[vw_Book_Lost_ByYear]    Script Date: 29-06-2020 8:27:39 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
Create View [dbo].[vw_Book_Lost_ByYear]
as

Select barcode, bname, page, qty, cost, catgname, typename, tbdid, [date], YEAR(date) [year_now] From tbBook_Lost
GO
/****** Object:  View [dbo].[vw_Book_Lost_ByMonth]    Script Date: 29-06-2020 8:27:39 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
Create View [dbo].[vw_Book_Lost_ByMonth]
as

Select barcode, bname, page, qty, cost, catgname, typename, tbdid, [date], Month(date) [month_now] From tbBook_Lost

--drop view vw_Book_Lost_ByYear
GO
/****** Object:  View [dbo].[vw_Book]    Script Date: 29-06-2020 8:27:39 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[tbTable]    Script Date: 29-06-2020 8:27:39 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  View [dbo].[vw_Return]    Script Date: 29-06-2020 8:27:39 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  View [dbo].[vw_ReturnBooks]    Script Date: 29-06-2020 8:27:39 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[tbStaff]    Script Date: 29-06-2020 8:27:39 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[tbUser]    Script Date: 29-06-2020 8:27:39 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  View [dbo].[vw_User]    Script Date: 29-06-2020 8:27:39 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[tbReserve]    Script Date: 29-06-2020 8:27:39 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[tbReserve_Detail]    Script Date: 29-06-2020 8:27:39 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  View [dbo].[vw_Reserves_Books]    Script Date: 29-06-2020 8:27:39 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[tbAthor]    Script Date: 29-06-2020 8:27:39 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[tbDepart]    Script Date: 29-06-2020 8:27:39 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[tbFine]    Script Date: 29-06-2020 8:27:39 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[tbRegister_cost]    Script Date: 29-06-2020 8:27:39 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[tbTableDetail]    Script Date: 29-06-2020 8:27:39 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[tbWrite]    Script Date: 29-06-2020 8:27:39 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
Begin DesignProperties = 
   Begin PaneConfigurations = 
      Begin PaneConfiguration = 0
         NumPanes = 4
         Configuration = "(H (1[68] 4[3] 2[3] 3) )"
      End
