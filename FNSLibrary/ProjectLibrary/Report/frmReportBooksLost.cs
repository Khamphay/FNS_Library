    ...
    public partial class frmReportBooksLost : Form
    {
        ...
        private void Report()
        {
            try
            {
                ...
                crBookLost = new CrReportBookLost();
                crBookLost.SetDataSource(ds);

                //Pass staff id
                discreteValue.Value = MyModel.staff[0];
                fieldDefinitions = crBookLost.DataDefinition.ParameterFields;
                ...
                //Show Report
                crystalReportViewer1.ReportSource = crBookLost;
