    ...
    public partial class frmNewUser : Form
    {
            ...
            try
            {
                ...
                { 
                    ...
                    if (table.Rows.Count <= 0)
                    {
                        ...
                        {
                            MyMessageBox.ShowMesage("ຊື່ ແລະ ລະຫັດບໍ່ຖຶກຕ້ອງ. ກະລຸນາກວດສອບແລ້ວ ລອງໃໝ່ແລ້ວອີກຄັ້ງ", "Save", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                        }
                    }
                    else
                    {
                ...
                {
                    MyMessageBox.ShowMesage("ກະລຸນາກວດສອບແລ້ວ ລອງໃໝ່ແລ້ວອີກຄັ້ງ", "Save", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                }
            }
            catch (Exception ex)
            {
       ...
       private void Clear_Text()
        ...
        private void btsave_Click(object sender, EventArgs e)
        {
            ...
            {
                MyMessageBox.ShowMesage("ລະຫັດບໍ່ຖຶກຕ້ອງ", "Warning", MessageBoxButtons.OK, MessageBoxIcon.Warning);
            }
        }
