...
using ProjectLibrary.FormShow.BooksInformation;
...
namespace ProjectLibrary
{
    public partial class Form1 : Form
    {
                ...
                try
                {
                    ...
                    if (dr.HasRows)
                    {
                        ...
                        if (MyModel.staff != null && MyModel.staff[4] == username && MyModel.staff[5] == pass)
                        {
                            ...
                            MyMessageBox.ShowMesage("ຊື່ ແລະ ລະຫັດຜ່ານບໍ່ຖຶກຕ້ອງ. ກະລຸນາກວດສອບແລ້ວລອງໃໝ່ແລ້ວອີກຄັ້ງ", "Login", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                    }
                    else
                    {
                        MyMessageBox.ShowMesage("ຊື່ ແລະ ລະຫັດຜ່ານບໍ່ຖຶກຕ້ອງ. ກະລຸນາກວດສອບຊື່ ແລະ ລະຫັດຜ່ານ ແລ້ວລອງໃໝ່ແລ້ວອີກຄັ້ງ", "Login", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                    }
                }
                catch (Exception ex)
                {
        ...
        private void btReportBooks_Click(object sender, EventArgs e)
        {
            frmReportBooks reportBooks = new frmReportBooks(this);
            ShowSubForm(reportBooks);
        }
